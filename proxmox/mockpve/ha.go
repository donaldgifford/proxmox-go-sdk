...
func (s *Server) registerHARoutes() {
	s.handle("GET /api2/json/cluster/ha/resources", s.handleHAResourceList)
	s.handle("POST /api2/json/cluster/ha/resources", s.handleHAResourceCreate)
	s.handle("GET /api2/json/cluster/ha/resources/{sid}", s.handleHAResourceGet)
	s.handle("PUT /api2/json/cluster/ha/resources/{sid}", s.handleHAResourceUpdate)
	s.handle("DELETE /api2/json/cluster/ha/resources/{sid}", s.handleHAResourceDelete)
	s.handle("GET /api2/json/cluster/ha/rules", s.handleHARuleList)
	s.handle("POST /api2/json/cluster/ha/rules", s.handleHARuleCreate)
	s.handle("GET /api2/json/cluster/ha/rules/{rule}", s.handleHARuleGet)
	s.handle("PUT /api2/json/cluster/ha/rules/{rule}", s.handleHARuleUpdate)
	s.handle("DELETE /api2/json/cluster/ha/rules/{rule}", s.handleHARuleDelete)
	s.handle("GET /api2/json/cluster/options", s.handleClusterOptionsGet)
	s.handle("PUT /api2/json/cluster/options", s.handleClusterOptionsSet)
	s.handle("GET /api2/json/cluster/ha/status/current", s.handleHAStatusCurrent)
	s.handle("GET /api2/json/cluster/ha/status/manager_status", s.handleHAManagerStatus)
	s.handle("POST /api2/json/cluster/ha/status/arm-ha", s.handleHAArm)
	s.handle("POST /api2/json/cluster/ha/status/disarm-ha", s.handleHADisarm)
	s.handle("POST /api2/json/cluster/ha/resources/{sid}/migrate", s.handleHAResourceMove)
	s.handle("POST /api2/json/cluster/ha/resources/{sid}/relocate", s.handleHAResourceMove)
	s.handle("GET /api2/json/cluster/replication", s.handleReplList)
	s.handle("POST /api2/json/cluster/replication", s.handleReplCreate)
	s.handle("GET /api2/json/cluster/replication/{id}", s.handleReplGet)
	s.handle("PUT /api2/json/cluster/replication/{id}", s.handleReplUpdate)
	s.handle("DELETE /api2/json/cluster/replication/{id}", s.handleReplDelete)
}
