...
func (s *Server) registerSDNRoutes() {
	s.handle("GET /api2/json/cluster/sdn/zones", s.handleZoneList)
	s.handle("POST /api2/json/cluster/sdn/zones", s.handleZoneCreate)
	s.handle("GET /api2/json/cluster/sdn/zones/{zone}", s.handleZoneGet)
	s.handle("PUT /api2/json/cluster/sdn/zones/{zone}", s.handleZoneUpdate)
	s.handle("DELETE /api2/json/cluster/sdn/zones/{zone}", s.handleZoneDelete)
	s.handle("GET /api2/json/cluster/sdn/vnets", s.handleVNetList)
	s.handle("POST /api2/json/cluster/sdn/vnets", s.handleVNetCreate)
	s.handle("GET /api2/json/cluster/sdn/vnets/{vnet}", s.handleVNetGet)
	s.handle("PUT /api2/json/cluster/sdn/vnets/{vnet}", s.handleVNetUpdate)
	s.handle("DELETE /api2/json/cluster/sdn/vnets/{vnet}", s.handleVNetDelete)
	s.handle("GET /api2/json/cluster/sdn/vnets/{vnet}/subnets", s.handleSubnetList)
	s.handle("POST /api2/json/cluster/sdn/vnets/{vnet}/subnets", s.handleSubnetCreate)
	s.handle("GET /api2/json/cluster/sdn/vnets/{vnet}/subnets/{subnet}", s.handleSubnetGet)
	s.handle("PUT /api2/json/cluster/sdn/vnets/{vnet}/subnets/{subnet}", s.handleSubnetUpdate)
	s.handle("DELETE /api2/json/cluster/sdn/vnets/{vnet}/subnets/{subnet}", s.handleSubnetDelete)
	s.handle("GET /api2/json/cluster/sdn/fabrics/fabric", s.handleFabricList)
	s.handle("POST /api2/json/cluster/sdn/fabrics/fabric", s.handleFabricCreate)
	s.handle("GET /api2/json/cluster/sdn/fabrics/fabric/{fabric}", s.handleFabricGet)
	s.handle("PUT /api2/json/cluster/sdn/fabrics/fabric/{fabric}", s.handleFabricUpdate)
	s.handle("DELETE /api2/json/cluster/sdn/fabrics/fabric/{fabric}", s.handleFabricDelete)
	s.handle("GET /api2/json/cluster/sdn/fabrics/node/{fabric}", s.handleFabricNodeList)
	s.handle("POST /api2/json/cluster/sdn/fabrics/node/{fabric}", s.handleFabricNodeCreate)
	s.handle("GET /api2/json/cluster/sdn/fabrics/node/{fabric}/{node}", s.handleFabricNodeGet)
	s.handle("PUT /api2/json/cluster/sdn/fabrics/node/{fabric}/{node}", s.handleFabricNodeUpdate)
	s.handle("DELETE /api2/json/cluster/sdn/fabrics/node/{fabric}/{node}", s.handleFabricNodeDelete)
	s.handle("PUT /api2/json/cluster/sdn", s.handleSDNApply)
	s.handle("GET /api2/json/nodes/{node}/sdn/zones", s.handleNodeSDNZones)
	s.handle("GET /api2/json/nodes/{node}/sdn/zones/{zone}/content", s.handleNodeSDNZoneContent)
	s.handle("GET /api2/json/nodes/{node}/sdn/zones/{zone}/bridges", s.handleNodeSDNZoneBridges)
	s.handle("GET /api2/json/nodes/{node}/sdn/zones/{zone}/ip-vrf", s.handleNodeSDNZoneIPVRF)
	s.handle("GET /api2/json/nodes/{node}/sdn/vnets/{vnet}/mac-vrf", s.handleNodeSDNVNetMACVRF)
	s.handle("GET /api2/json/nodes/{node}/sdn/fabrics/{fabric}/interfaces", s.handleNodeSDNFabricInterfaces)
	s.handle("GET /api2/json/nodes/{node}/sdn/fabrics/{fabric}/neighbors", s.handleNodeSDNFabricNeighbors)
	s.handle("GET /api2/json/nodes/{node}/sdn/fabrics/{fabric}/routes", s.handleNodeSDNFabricRoutes)
}
