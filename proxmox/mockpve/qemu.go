...
func (s *Server) registerQEMURoutes() {
	s.handle("GET /api2/json/nodes/{node}/qemu", s.handleQEMUList)
	s.handle("POST /api2/json/nodes/{node}/qemu", s.handleQEMUCreate)
	s.handle("GET /api2/json/nodes/{node}/qemu/{vmid}/status/current", s.handleQEMUStatus)
	s.handle("GET /api2/json/nodes/{node}/qemu/{vmid}/config", s.handleQEMUConfig)
	s.handle("PUT /api2/json/nodes/{node}/qemu/{vmid}/config", s.handleQEMUSetConfig)
	...
	s.handle("GET /api2/json/nodes/{node}/qemu/{vmid}/snapshot", s.handleQEMUSnapshotList)
	s.handle("POST /api2/json/nodes/{node}/qemu/{vmid}/snapshot", s.handleQEMUSnapshotCreate)
	s.handle("POST /api2/json/nodes/{node}/qemu/{vmid}/snapshot/{snap}/rollback", s.handleQEMUSnapshotRollback)
	s.handle("DELETE /api2/json/nodes/{node}/qemu/{vmid}/snapshot/{snap}", s.handleQEMUSnapshotDelete)
	s.handle("POST /api2/json/nodes/{node}/qemu/{vmid}/agent/ping", s.handleQEMUAgentPing)
	s.handle("POST /api2/json/nodes/{node}/qemu/{vmid}/agent/exec", s.handleQEMUAgentExec)
	s.handle("GET /api2/json/nodes/{node}/qemu/{vmid}/agent/exec-status", s.handleQEMUAgentExecStatus)
}
