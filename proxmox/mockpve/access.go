...
func (s *Server) registerAccessRoutes() {
	s.handle("GET /api2/json/access/users", s.handleUserList)
	s.handle("POST /api2/json/access/users", s.handleUserCreate)
	s.handle("GET /api2/json/access/users/{userid}", s.handleUserGet)
	s.handle("PUT /api2/json/access/users/{userid}", s.handleUserUpdate)
	s.handle("DELETE /api2/json/access/users/{userid}", s.handleUserDelete)
	s.handle("GET /api2/json/access/groups", s.handleGroupList)
	s.handle("POST /api2/json/access/groups", s.handleGroupCreate)
	s.handle("GET /api2/json/access/groups/{groupid}", s.handleGroupGet)
	s.handle("PUT /api2/json/access/groups/{groupid}", s.handleGroupUpdate)
	s.handle("DELETE /api2/json/access/groups/{groupid}", s.handleGroupDelete)
	s.handle("GET /api2/json/access/roles", s.handleRoleList)
	s.handle("POST /api2/json/access/roles", s.handleRoleCreate)
	s.handle("GET /api2/json/access/roles/{roleid}", s.handleRoleGet)
	s.handle("PUT /api2/json/access/roles/{roleid}", s.handleRoleUpdate)
	s.handle("DELETE /api2/json/access/roles/{roleid}", s.handleRoleDelete)
	s.handle("GET /api2/json/access/acl", s.handleACLList)
	s.handle("PUT /api2/json/access/acl", s.handleACLSet)
	s.handle("GET /api2/json/access/users/{userid}/token", s.handleTokenList)
	s.handle("GET /api2/json/access/users/{userid}/token/{tokenid}", s.handleTokenGet)
	s.handle("POST /api2/json/access/users/{userid}/token/{tokenid}", s.handleTokenCreate)
	s.handle("PUT /api2/json/access/users/{userid}/token/{tokenid}", s.handleTokenUpdate)
	s.handle("DELETE /api2/json/access/users/{userid}/token/{tokenid}", s.handleTokenDelete)
}
