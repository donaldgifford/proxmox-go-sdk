...
- [Open Questions](#open-questions)
  - [OQ-1. Package layering for shared primitives + the error taxonomy — RESOLVED (a)](#oq-1-package-layering-for-shared-primitives--the-error-taxonomy--resolved-a)
  - [OQ-2. Node-failover behavior (WithClusterEndpoints) — RESOLVED (a)](#oq-2-node-failover-behavior-withclusterendpoints--resolved-a)
  - [OQ-3. Ticket-refresh strategy (user/pass auth) — RESOLVED (a)](#oq-3-ticket-refresh-strategy-userpass-auth--resolved-a)
  - [OQ-4. How mockpve models PVE — RESOLVED (c)](#oq-4-how-mockpve-models-pve--resolved-c)
  - [OQ-5. Integration-test harness — RESOLVED (a)](#oq-5-integration-test-harness--resolved-a)
  - [OQ-6. Modeling the sprawly config objects (net0=virtio,bridge=vmbr0, …) — RESOLVED (a)](#oq-6-modeling-the-sprawly-config-objects-net0virtiobridgevmbr0---resolved-a)
  - [OQ-7. Home for the apidoc.js schema-drift tool — RESOLVED (a)](#oq-7-home-for-the-apidocjs-schema-drift-tool--resolved-a)
  - [OQ-8. Node-networking package placement — RESOLVED (a)](#oq-8-node-networking-package-placement--resolved-a)
  - [OQ-9. Delivery shape — strict phases or a vertical slice first? — RESOLVED (a)](#oq-9-delivery-shape--strict-phases-or-a-vertical-slice-first--resolved-a)
  - [OQ-10. What powers the shipped mockpve server? (surfaced by OQ-4) — RESOLVED (a)](#oq-10-what-powers-the-shipped-mockpve-server-surfaced-by-oq-4--resolved-a)
