...
| IMPL-0002 | Dogfood harness buildout: pvelab, cluster surface, P4/P6 closure | Completed   | 2026-07-09 | Donald Gifford | [0002-dogfood-harness-buildout-pvelab-cluster-surface-p4p6-closure.md](0002-dogfood-harness-buildout-pvelab-cluster-surface-p4p6-closure.md) |
...
| IMPL-0008 | Cluster storage config writes delivery                           | Completed   | 2026-08-26 | Donald Gifford | [0008-cluster-storage-config-writes-delivery.md](0008-cluster-storage-config-writes-delivery.md)                                             |
| IMPL-0009 | Cluster storage config writes consumer verification              | Draft       | 2026-08-26 | Donald Gifford | [0009-cluster-storage-config-writes-consumer-verification.md](0009-cluster-storage-config-writes-consumer-verification.md)                   |
