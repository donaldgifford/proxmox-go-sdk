...
- *(impl-0008)* Close the ledger — v0.12.0 shipped, consumer-exercised
...
- *(ci)* Import the GPG key so goreleaser signing stops failing every release

### Miscellaneous Tasks

- *(dogfood)* Pin the dogfood recipes to pvelab v0.6.0 (IMPL-0002 Phase 4)
